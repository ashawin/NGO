...
<div class="mb-5">
    <div class="page-header mb-0">
        <h3 class="page-title">Add Donation Page</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add Donation Page</li>
        </ol>
    </div>
</div>
...
<div class="row">
<div class="col-lg-12">
    <form  method="post" class="card" action="/eficor/administrator/donation/add" enctype="multipart/form-data">
         @csrf
        <div class="card-header">
            <h3 class="card-title">Add Donation Page</h3>
        </div>
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="keywords" placeholder="Please Enter The Keyword">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="leftcontent" id="leftcontent" rows="6" placeholder="Slider Description"></textarea>
                    </div>                   
                    <div class="form-group">
                        <label class="form-label">Right Content<span class="form-label-small">56/100</span></label>
                        <textarea class="form-control" name="rightcontent" id="rightcontent" rows="6" placeholder="Slider Description"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Youtube Video<span class="form-label-small">56/100</span></label>
                        <textarea class="form-control" name="video" id="video" rows="6" placeholder="Slider Description"></textarea>
                    </div>
                    <div class="form-group">

...
<div class="mb-5">
    <div class="page-header mb-0">
        <h3 class="page-title">Manage Donation Pages</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Manage Donation Pages</li>
        </ol>
    </div>
</div>
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Manage Donation </h3>
                <div class="float-right ml-auto">
                    <a href="/eficor/administrator/donation/add" class="btn btn-primary btn-sm"><i class="si si-plus mr-1"></i>Add New Donation Ship</a>
                </div>
            </div>
            <div class="card-body">

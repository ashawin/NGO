...
<div class="mb-5">
    <div class="page-header mb-0">
        <h3 class="page-title">About Strategy</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">About Strategy</li>
        </ol>
    </div>
</div>
...
<div class="row">
<div class="col-lg-12">
    <form  method="post" class="card" action="/eficor/administrator/cms/about-strategy" enctype="multipart/form-data">
         @csrf
        <div class="card-header">
            <h3 class="card-title">About Strategy</h3>
        </div>
        <div class="row">

...
<div class="mb-5">
    <div class="page-header mb-0">
        <h3 class="page-title">Add Financial</h3>
        <ol class="breadcrumb">
...
<div class="row">
<div class="col-lg-12">
    <form  method="post" class="card" action="/eficor/administrator/cms/about-financials-details/add" enctype="multipart/form-data">
         @csrf
        <div class="card-header">
            <h3 class="card-title">Add Financial</h3>
        </div>
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="form-group">
                        <label class="form-label">Financial Tile</label>
                ...
                <div class="col-md-6 col-lg-12">
                    <div class="form-group">
                        ...
                        <select name="financialGroup" id="financialGroup" class="form-control">
                            ...
                            <?php foreach($pageFins as $singleGroup) {

                                ?>
                                <option value="<?=$singleGroup->id?>"><?=$singleGroup->title?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>

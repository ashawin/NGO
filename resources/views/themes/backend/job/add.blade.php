...
@section('content')
    <div class="side-app">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form  method="post" class="card" action="{{route('add_job')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="desc" rows="6" placeholder="Slider Description"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="location" rows="6" placeholder="Slider Description"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- end fields -->

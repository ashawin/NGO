...
@section('content')
    ...
    <div class="main-content">
                ...
                <div class="section-content text-center">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3 text-center">
                            <h2 class="text-theme-colored font-36">Thank You</h2>
        ...
        <!-- Section: About -->
        <!-- Section: Volunteer -->
        <h3 style="text-align: center   ;margin-top: 100px" class="alert-info"> Thank you for contacting with us. We will be soon
            with you.</h3>

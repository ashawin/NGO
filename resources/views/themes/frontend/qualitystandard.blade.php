                ...
                <div class="col-md-12" style="margin-top:50px;">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                            <div class="schedule-box maxwidth500 bg-light mb-30" style="max-height: 800px">
                                <div class="thumb">
                                    <img  alt="" src="{{asset('uploads/pages/'.$qua->image)}}" height="200px" width="400px">
                                </div>
                            ...
                            @if(count($quality)>=6)
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3 text-center">
                                        <h3><a href="{{route('morequalitystd')}}">View More</a></h3>

                ...
                <div class="section-content text-center">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3 text-center">
                            ...
                            @endif
                            @if($slug=='annual-report')
                                <div class="col-md-6 col-md-offset-3 text-center">
                                    <h2 class="text-theme-colored font-36">ANNUAL REPORTS</h2>
                            ...
                            <div class="col-sm-6 col-md-3 mb-sm-60 text-left sm-text-center">
                                <div class="volunteer border bg-white-fa maxwidth400 mb-30 p-30">
                                    ...
                                    <div class="info" style="min-height: 150px">
                                        <h4>{{$annual->title}}</h4>
                                        <h6 class="name"><a href="{{asset('uploads/pages/'.$annual->pdf)}}" target="_blank"> EFICOR Annual Report {{$annual->created_at}}</a></h6>

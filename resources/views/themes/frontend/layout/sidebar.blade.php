...
<aside class="app-sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="#Volunteeers"><i class="side-menu__icon si si-screen-layers"></i><span class="side-menu__label">Volunteeers</span><i class="angle fas fa-angle-right"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="/eficor/administrator/cms/volunteeers">Manage Volunteeers</a></li>
            </ul>
        </li>        
        <li class="slide">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li>
                    <a href="/eficor/administrator/donater" class="slide-item">Manage Donater</a>
                </li>
            </ul>
        </li>
        <li class="slide">
